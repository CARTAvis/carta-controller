...
export function populateUserMap(
	userMaps: Map<string, UserMap>,
...
export function watchUserTable(
	userMaps: Map<string, UserMap>,
...
export function generateExternalVerifiers(
	verifierMap: Map<string, Verifier>,
	authConf: CartaExternalAuthConfig,
) {
