...
Detailed step-by-step instructions are provided for :ref:`Ubuntu 20.04 (Focal Fossa)<focal_instructions>` and :ref:`AlmaLinux 8.4<almalinux_instructions>`. We officially support Ubuntu 20.04 and 18.04, and RHEL 7 and 8, with all available standard updates applied.
