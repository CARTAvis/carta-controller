...
.. |backend-github| image:: https://img.shields.io/badge/CARTA%20Version-4.0.0--rc.0-brightgreen
        :alt: View this backend version on GitHub
        :target: https://github.com/CARTAvis/carta-backend/releases/tag/v4.0.0-rc.0
